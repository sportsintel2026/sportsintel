      ...
      <AuthLayout title="Check your email" subtitle="We sent you a confirmation link">
        <div style={{ textAlign: "center", padding: "20px 0" }}>
          ...
          <div style={{ fontSize: 14, color: "#64748b", lineHeight: 1.7 }}>
            Click the link in your email to verify your account and start using SportsIntel.
          </div>
          <Link to="/login" style={{ display: "block", marginTop: 24, color: "#ef4444", textDecoration: "none", fontWeight: 600, fontSize: 14 }}>
            Back to Sign In
          </Link>
        </div>
      </AuthLayout>
