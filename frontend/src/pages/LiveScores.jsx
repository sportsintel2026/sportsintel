...
function ErrorState({ onRetry }) {
  return (
    <div style={{ textAlign: "center", padding: 64, background: "linear-gradient(180deg,#0c0c0e,#020203)", border: "1px solid #16202a", borderRadius: 14 }}>
...
function EmptyState({ icon, league }) {
  ...
  if (offSeason) {
    return (
      <div style={{ background: "linear-gradient(180deg,#0c0c0e,#020203)", border: "1px solid #16202a", borderRadius: 14, padding: 48, textAlign: "center" }}>
