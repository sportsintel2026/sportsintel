...
.gr{position:relative;margin-bottom:12px;background:#16130d;border:1px solid rgba(255,255,255,.72);border-radius:16px;overflow:hidden;cursor:pointer}
...
.gr.sel{border-color:rgba(255,255,255,.92)}
.pband{padding:13px 15px;background:#1d1810;border-bottom:1px solid #261f14}
.pbtop{display:flex;align-items:center;justify-content:space-between}
.pbL{display:flex;align-items:center;gap:11px}
.pband .lgs .lg{border-color:#1d1810}
...
.pee{font-family:var(--mono);font-size:8px;color:#6e6354;letter-spacing:1.5px;font-weight:700;margin-top:2px}
.psub{font-size:11.5px;color:#b3a48e;margin-top:9px;line-height:1.45}
...
.pval{background:#100d08;border:1px solid #241d12;border-radius:11px;padding:11px 12px}
.pvrow{display:flex;align-items:center;justify-content:space-between;margin-bottom:10px}
.pvc{flex:1}.pvc.r{text-align:right}
.pvl{font-family:var(--mono);font-size:8px;color:#6e6354;letter-spacing:1px;font-weight:700}
...
.pbar{position:relative;height:8px;background:#1a150d;border-radius:4px;overflow:hidden}
.pbar .bf{position:absolute;left:0;top:0;height:100%;background:#3a3020}
.pbar .of{position:absolute;top:0;height:100%;background:#33e991}
.gr.med .pbar .of{background:#e0b050}
.pble{display:flex;justify-content:space-between;margin-top:5px;font-family:var(--mono);font-size:8.5px;color:#8c8070}
.pble .g{color:#33e991;font-weight:700}.gr.med .pble .g{color:#cdb878}
.pfoot{display:flex;align-items:center;justify-content:space-between;border-top:1px solid #241d12;margin:11px -12px 0;padding:11px 12px 0}
.pconv{display:flex;align-items:center;gap:7px}
.pmeter{display:flex;gap:2px}.pmeter i{width:6px;height:12px;background:#332e1c;border-radius:1.5px;display:block}
...
.pmt{font-family:var(--mono);font-size:9px;color:#a89a86}.pmt.up{color:#33e991}.pmt.dn{color:#d8795a}
.gr .dwrap{margin:0 15px;padding-bottom:14px;border-top-color:#2a2114}
.gr .dhead .nm{color:#fff}.gr .dhead .mu{color:#a89a86}.gr .dhead .st{color:#a89a86}
.gr .mvm .lbls .ml{color:#33e991}.gr .mvm .lbls .mk2{color:#a89a86}
.gr .mvm .bar{background:#1a150d}.gr .mvm .bar i{background:#33e991}
.gr .dchip{color:#d8cdba;border-color:#2e271b;background:#120e08}.gr .dchip b{color:#a89a86}.gr .dchip.g{color:#33e991}.gr .dchip.gold{color:#e0b050}
.gr .flags .ok{color:#33e991}.gr .flags .warn{color:#ff6a5a}.gr .flags .info{color:#5da9e8}.gr .flags .mu{color:#a89a86}
.gr .why{color:#c4b6a0}.gr .why b{color:#a89a86}
.gr .rdbox{border-color:#2e271b;background:#120e08}
.gr .rdbox .rl{color:#a89a86;background:#0d0a05}
.gr .rdrow{border-top-color:#241d12}.gr .rdrow .leg{color:#6e6354}.gr .rdrow .pk{color:#d8cdba}
.gr .tier.strong{color:#33e991}.gr .tier.soft{color:#e0b050}.gr .tier.split{color:#ff6a5a}
.gr .ag.y{color:#33e991}.gr .ag.n{color:#a89a86}
