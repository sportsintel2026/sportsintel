...
section{padding:0 11px;margin-top:9px}
...
.ec{border:1px solid #1a232c;border-radius:13px;background:linear-gradient(180deg,#0d1218,#090d12);padding:9px 8px}
