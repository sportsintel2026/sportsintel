...
.wzpr{--bg:#0A0B0D;--panel:#14171B;--ink:#E8ECEF;--mut:#9AA4AD;--dim:#5C6770;
...
.wzpr .logo .dot{width:8px;height:8px;border-radius:50%;background:var(--green);box-shadow:0 0 10px rgba(63,203,145,.6)}
.wzpr .logo b{color:var(--gold);font-weight:700}
.wzpr .close{font-family:var(--mono);font-size:12px;color:var(--mut);letter-spacing:.03em}
.wzpr .close:hover{color:var(--ink)}
.wzpr .eyebrow{font-family:var(--mono);font-size:11.5px;letter-spacing:.24em;text-transform:uppercase;color:var(--gold);display:flex;align-items:center;gap:11px;margin-bottom:18px}
.wzpr .eyebrow::before{content:"";width:24px;height:1px;background:var(--gold);opacity:.6}
...
.wzpr h1 em{font-style:normal;color:var(--gold)}
...
.wzpr .plan:hover{border-color:#3a434c}
.wzpr .plan:focus-visible{outline:2px solid var(--gold);outline-offset:2px}
.wzpr .plan.on{border-color:var(--gold);background:rgba(201,168,106,.07)}
...
.wzpr .plan.on .radio{border-color:var(--gold)}
.wzpr .radio i{width:9px;height:9px;border-radius:50%;background:var(--gold);transform:scale(0);transition:transform .15s}
...
.wzpr .tag.pop{color:var(--gold);background:rgba(201,168,106,.12);border:1px solid rgba(201,168,106,.32)}
.wzpr .tag.best{color:#04140d;background:var(--green)}
...
.wzpr .plan.on .price .amt{color:var(--gold)}
...
.wzpr .incl li svg{flex:0 0 auto;margin-top:2px;color:var(--green)}
.wzpr .cta{width:100%;background:var(--gold);color:#1a1408;border:none;border-radius:13px;padding:17px;font-family:var(--disp);font-weight:700;font-size:16.5px;letter-spacing:-.01em;cursor:pointer;transition:transform .1s,background .15s;box-shadow:0 12px 30px -12px rgba(201,168,106,.5)}
...
.wzpr .free a{color:var(--gold);font-weight:600}
.wzpr .free a:hover{color:var(--up,#46E0A9)}
