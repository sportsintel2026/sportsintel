...
const feeds = {
  nfl: {
    teaser: true,
    games: [{ id: "nfl-1", awayTeam: "New England Patriots", homeTeam: "Seattle Seahawks", commenceTime: "2026-09-10T00:20:00Z", modelProb: 0.61, edge: 0.07 }],
  },
  cfb: {
    teaser: true,
    games: [{ id: "cfb-1", awayTeam: "Missouri Tigers", homeTeam: "Kansas Jayhawks", commenceTime: "2026-09-12T00:00:00Z", modelProb: 0.59, edge: 0.04 }],
  },
  mlb: {
    teaser: true,
    date: "2026-09-08",
    games: [{ id: "mlb-1", away: "Cleveland Guardians", home: "Baltimore Orioles", time: "6:35 PM ET", modelProb: 0.57, edge: 0.03 }],
  },
};
